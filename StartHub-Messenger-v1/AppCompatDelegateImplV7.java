...
import com.wsocialrewapp.C0712R;
...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01261 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & UTF16Reader.DEFAULT_BUFFER_SIZE) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0712R.styleable.Theme_spinnerStyle);
            }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0712R.styleable.Theme_spinnerStyle, subMenu);
            }
            return true;
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0712R.styleable.Theme_spinnerStyle);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0131R.styleable.Theme_windowActionBar)) {
            if (a.getBoolean(C0131R.styleable.Theme_windowNoTitle, false)) {
                ...
                requestWindowFeature(C0712R.styleable.Theme_spinnerStyle);
            }
            if (a.getBoolean(C0131R.styleable.Theme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0712R.styleable.Theme_switchStyle);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0712R.styleable.Theme_switchStyle);
                }
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0712R.styleable.Theme_spinnerStyle) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case MetaData.DEFAULT_MAX_ADS /*10*/:
                ...
                return true;
            case C0712R.styleable.Theme_spinnerStyle /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0712R.styleable.Theme_switchStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0712R.styleable.Theme_spinnerStyle) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case ConnectionResult.SIGN_IN_REQUIRED /*4*/:
                ...
                break;
            case C0712R.styleable.Theme_colorPrimary /*82*/:
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0712R.styleable.Theme_spinnerStyle, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0712R.styleable.Theme_spinnerStyle, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0712R.styleable.Theme_spinnerStyle) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0712R.styleable.Theme_spinnerStyle) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0712R.styleable.Theme_spinnerStyle, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0712R.styleable.Theme_spinnerStyle || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0712R.styleable.Theme_spinnerStyle;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0712R.styleable.Theme_switchStyle;
        }
    }
